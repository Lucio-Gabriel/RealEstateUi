<template>
    <section class="max-w-6xl mx-auto m-32">
        <div class="flex flex-col items-center justify-center">
            <h2 class="font-semibold text-5xl">
                Nossos Serviços
            </h2>

            <p class="max-w-md text-center text-slate-600 font-normal mt-10">
                Melhore seus anúncios de imóveis e vídeos com
                legendas precisas e envolventes.
            </p>
        </div>
            ...
            <div class="bg-slate-300 flex gap-5 py-10 px-5 max-w-md rounded-[30px] md:ml-32 mt-3">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" 
                        ...
                        <path d="M12 10l0 3l2 0" /><path d="M7 4l-2.75 2" /><path d="M17 4l2.75 2" />
                    </svg>
                </div>
